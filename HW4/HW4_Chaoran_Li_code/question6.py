...
"""
Question 6:
Implement the Adam algorithm to train a logistic regression model for the Titantic dataset. Report the overall
classification accuracies on the training and testing sets and report the precision, recall, and F-measure scores for
each of the two classes on the training and testing sets.
...
class MyLogisticRegression:
    def __init__(self, _a_id, _alpha=1e-2, _steps=1e3, _batch=50, _epsilon=1e-8, _rho1=0.9, _rho2=0.999):
